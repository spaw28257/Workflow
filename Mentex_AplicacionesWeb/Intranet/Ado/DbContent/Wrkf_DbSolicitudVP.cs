...
namespace Intranet.Ado.DbContent
{
    public class Wrkf_DbSolicitudVP
    {
        ...
        /// </summary>
        /// <returns></returns>
        public List<Wrkf_ListaPagosPorRubroId> ListaPagosPorRubroIdVP(int gruporubro, string rubro_id, DateTime fechadesde, DateTime fechahasta, bool documento_nc)
        {
            ...
            DataTable DtRubrosContralor = Sqlprovider.ExecuteStoredProcedureWithOutputParameter("workflow.PL_Sel_ListaPagosPorRubroIdVpFinanza", 
                                                                                                CommandType.StoredProcedure, 
                                                                                                out Dictionary<string, string> outparam);
        ...
        public List<Wrkf_ListaPagosPorRubroId> ListaPagosPorRubroIdVP_Urgentes(int gruporubro, string rubro_id, DateTime fechadesde, DateTime fechahasta)
        {
            List<Wrkf_ListaPagosPorRubroId> lstlistapagosporrubroid = new List<Wrkf_ListaPagosPorRubroId>();
            Wrkf_DbMensajeError objwrkfdbmensajeerror = new Wrkf_DbMensajeError();
            double totalapagarx;
            ...
            DataTable DtRubrosContralor = Sqlprovider.ExecuteStoredProcedureWithOutputParameter("workflow.PL_Sel_ListaPagosPorRubroIdVpFinanza_Ugentes", 
                                                                                                CommandType.StoredProcedure, 
                                                                                                out Dictionary<string, string> outparam);
        ...
        public Wrkf_RespuestaOperacion RegistrarMotivoRechazo(int Solicitudordenpagodetalle_Id, int Solicitudordenpago_Id, string motivorechazo, string usuario)
        {
            ...
            try
            {
                ...
                transaccion = Sqlprovider.InicioTransaccion("RegistrarMotivoRechazoVP", sqlconexion);
                ...
                Sqlprovider.Oparameters.AddRange(new SqlParameter[] {
                    ...
                    new SqlParameter("@ObservacionesVPFinanza", motivorechazo.Substring(0, longitudmotivorechazo)),
                });

                string sqlQuery = "update Workflow.SolicitudOrdenPagoDetalle ";
                sqlQuery += "set ObservacionesVPFinanza = @ObservacionesVPFinanza, ";
        ...
        /// <summary>
        /// Aprobar y rechazar las solicitudes de pagos por VP
        /// </summary>
        /// <returns></returns>
        public Wrkf_RespuestaOperacion AprobarRechazarSolicitudVP(string listapagosaprobados, string listapagosrechazados, string usuario)
        {
            Wrkf_RespuestaOperacion wrkf_RespuestaOperacion = new Wrkf_RespuestaOperacion();
            ...
            int Result = Sqlprovider.ExecuteStoredProcedureWithOutputParameter2("Workflow.sp_up_AprobarRechazarSolicitudVp", CommandType.StoredProcedure, out Dictionary<string, string> outparam);

            //Obtiene El Error Generado Desde El Procedimiento Almacenado [Workflow].[sp_up_AprobarRechazarSolicitudVp]
