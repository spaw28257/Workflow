...
namespace Intranet.Ado.DbContent
{
    ...
    public class Wrkf_DbSolicitudContralor
    {
        ...
        /// </summary>
        /// <returns></returns>
        public List<Wrkf_GrupoRubro> lstGrupoRubroContralor()
        {
            ...
            string vSqlProcedureName = "workflow.PL_Sel_GrupoRubrosContralor";
        ...
        /// <summary>
        /// Lista los pagos por rubro pendientes por aprobar por contraloria
        /// </summary>
        /// <param name="pgrid"></param>
        /// <param name="pprioridadpago"></param>
        /// <returns></returns>
        public List<Wrkf_Rubro> LstRubroContralor(int pgrid, int pprioridadpago)
        {
            ...
            string vSqlProcedureName = "WorkFlow.PL_Sel_RubrosContraloria";
        ...
        /// </summary>
        /// <returns></returns>
        public List<Wrkf_SolicitudOrdenPago> ListaPagosPorRubroIdContraloriaDb(Int32 pgruporubro_id, string prubro_id, string pfechadesde, string pfechahasta, int pprioridadpago)
        {
            ...
            string vSqlProcedureName = "WorkFlow.PL_Sel_ListaPagosPorRubroIdContraloria";
        ...
        /// </summary>
        /// <returns></returns>
        public Wrkf_RespuestaOperacion AprobarRechazarSolicitudContraloria(string pcodigo, string pusuario, string pobservaciones, string paccion)
        {
            ...
            Sqlprovider.ExecuteStoredProcedureWithOutputParameter2("WorkFlow.PL_Up_AprobarRechazarSolicitudContraloria_key", CommandType.StoredProcedure, out Dictionary<string, string> outparam);
